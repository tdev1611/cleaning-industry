            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Danh sách bài viết</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                    {{-- alert --}}
                                ...
                                <div class="table-responsive">
                                    <table id="myTable"
                                        ...
                                        <tbody>
                                            @forelse ($news as $new)
                                                <tr>
                                                    <td scope="row">{{ $new->ordinal }}</td>
                                                    <td>{{ $new->title }}</td>
                                                    <td>
                                                        <img height="60" src="{{ url($new->image) }}"
                                                            alt="{{ $new->title }}">
                                                    </td>
                                                    ...
                                                    <td>{{ date_format($new->created_at, 'Y/m/d') }}</td>
                                                    <td>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Xóa tin
                                                                    tức <b><i> {{ $new->title }}</i></b> </h1>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('admin.news.delete', $new->id) }}">Xóa</a>
                                            ...
                                            @empty
                                                <td colspan="7">Chưa có tin tức nào</td>
                                            @endforelse
                                        </tbody>
                                    </table>
                                </div>
